...
/**
 * Fixed bottom-right live local clock + X profile link for canvas chrome.
...
export function CanvasLiveClock() {
  ...
  return (
    ...
    >
      <time
        className="font-mono text-[10px] leading-none tracking-wide text-[color:var(--canvas-muted,#a3a3a3)] tabular-nums sm:text-[11px]"
      ...
      <a
        ...
        className="inline-flex size-6 shrink-0 items-center justify-center text-[color:var(--canvas-muted,#a3a3a3)] transition-colors hover:text-[color:var(--canvas-fg,#171717)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-400"
